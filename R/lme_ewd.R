...
#' @param ... parametry: 'newdata' - ramka danych, dla których należy wyliczyć przewidywania oraz
#' 'zLosowymi' -  wartość boolowska określająca, czy uwzględniać w przewidywaniach efekt losowy.
#' @return wektor liczb.
#' @export
predict.lmeEWD <-function(object, ...){
  ...
  if (zLosowymi) {
    # zaszyta rekurencja w funkcji ewd_me_ssr(), która korzysta z predict.lmeEWD() bez efektow losowych 
